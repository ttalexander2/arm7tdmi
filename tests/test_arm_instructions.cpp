...
TEST_CASE("branch_and_exchange", "[arm_instruction]") {
...
TEST_CASE("block_data_transfer", "[arm_instruction]") {
...
TEST_CASE("branch_and_branch_with_link", "[arm_instruction]") {
...
TEST_CASE("software_interupt", "[arm_instruction]") {
...
TEST_CASE("undefined", "[arm_instruction]") {
...
TEST_CASE("single_data_transfer", "[arm_instruction]") {
...
TEST_CASE("single_data_swap", "[arm_instruction]") {
...
TEST_CASE("multiply", "[arm_instruction]") {
...
TEST_CASE("multiply_long", "[arm_instruction]") {
...
TEST_CASE("halfword_data_transfer_register", "[arm_instruction]") {
...
TEST_CASE("halfword_data_transfer_immediate", "[arm_instruction]") {
...
TEST_CASE("psr_transfer_mrs", "[arm_instruction]") {
...
TEST_CASE("psr_transfer_msr", "[arm_instruction]") {

    constexpr u32 opcode = 0x000A5190;
    const auto instr = arm7tdmi::arm::decode(opcode);
    REQUIRE(instr == arm7tdmi::arm::instruction::psr_transfer_msr);
}
TEST_CASE("data_processing", "[arm_instruction]") {
